<?php
namespace Beheist\NW\Fusion;

use Neos\Flow\Annotations as Flow;
use Neos\ContentRepository\Domain\Model\NodeInterface;
use Neos\Fusion\Exception as TypoScriptException;
use Neos\Fusion\Exception;
use Neos\Neos\Fusion\AbstractMenuImplementation;

/**
 * EXACT MATCH OF MenuImplementation except it also takes FlowQuery objects to build menus
 */
class MenuImplementation extends AbstractMenuImplementation
{
     ...
     * @return array
     */
    protected function buildMenuLevelRecursive($menuLevelCollection)
    {
        $items = array();
